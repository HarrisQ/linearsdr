...
linearsdr:::ggplot_fsdr(Y1, t((X1)%*%b_hat_sir[,1]), y_on_axis=T,
                        ytype="continuous",
                        h_lab='SIR 1', v_lab='Y',
...
Y3_1 = as.numeric(energy_datta$Y3_1)
Y3_2 = as.numeric(energy_datta$Y3_2)
...
b_hat_sir3_1 = sir(x=X3, y=Y3_1, nslices = 10, d=2, 
                   ytype = "continuous" )$beta

b_hat_sir3_2 = sir(x=X3, y=Y3_2, nslices = 10, d=2, 
                   ytype = "continuous" )$beta
...
linearsdr:::ggplot_fsdr(Y3_3, t((X3)%*%b_hat_sir3_2[,1]), y_on_axis=T,
                        ytype="continuous",
                        h_lab='SIR 1', v_lab='SIR 2',
                        main_lab= paste0('SIR'), size=3)
...
b_hat_save3_1 = save_sdr(x=X3, y=Y, nslices = 5, d=2, ytype = "continuous" )$beta

b_hat_save3_2 = save_sdr(x=X3, y=Y, nslices = 5, d=2, ytype = "continuous" )$beta


linearsdr:::ggplot_fsdr(Y, t((X3)%*%b_hat_save[,1]), y_on_axis=T, 
                        ytype="continuous",
                        h_lab='DR 1', v_lab='Y',
                        main_lab= paste0('DR'), size=2.5)
...
b_hat_dr3_1 = dr(x=X3, y=Y1, nslices = 10, d=2, ytype = "continuous" )$beta

b_hat_dr3_2 = dr(x=X3, y=Y1, nslices = 10, d=2, ytype = "continuous" )$beta


linearsdr:::ggplot_fsdr(Y1, t((X3)%*%b_hat_dr[,1]), y_on_axis=T,
                        ytype="continuous",
                        h_lab='DR 1', v_lab='DR 2',
