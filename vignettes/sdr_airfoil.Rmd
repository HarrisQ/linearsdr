...
linearsdr:::ggplot_fsdr(Y, t((X)%*%b_hat_sir), y_on_axis=T, ytype="continuous",
...
linearsdr:::ggplot_fsdr(Y, t((X)%*%b_hat_dr), y_on_axis=F, ytype="continuous",
...
linearsdr:::ggplot_fsdr(Y, t((X)%*%b_hat_opg)[1:2,], y_on_axis=F,
                        ytype="continuous",
