...
linearsdr:::ggplot_fsdr(Y1_test, t((X1_test_std)%*%b_hat_opcg1[,c(1,2)]),
                                     y_on_axis=F,
                                     ytype="multinomial",
                                     h_lab='OPCG 1', v_lab='OPCG 2',
                                     main_lab= paste0('OPCG'), size=2.5)

linearsdr:::ggplot_fsdr(Y1_test, t((X1_test_std)%*%b_hat_opcg1[,c(2,3)]),
                                     y_on_axis=F,
                                      ytype="multinomial",
                                      h_lab='OPCG 2', v_lab='OPCG 3',
                                      main_lab= paste0('OPCG'), size=2.5)

linearsdr:::ggplot_fsdr(Y1_test, t((X1_test_std)%*%b_hat_opcg1[,c(1,3)]),
                                     y_on_axis=F,
                                      ytype="multinomial",
...
#
# 
linearsdr:::ggplot_fsdr(Y1_test, t((X1_test_std)%*%b_hat_made1[,c(1,2)]),
                                     y_on_axis=F,
                                     ytype="multinomial",
                                     h_lab='MADE 1', v_lab='MADE 2',
                                     main_lab= paste0('MADE'), size=2.5)

linearsdr:::ggplot_fsdr(Y1_test, t((X1_test_std)%*%b_hat_made1[,c(2,3)]),
                                     y_on_axis=F,
                                      ytype="multinomial",
                                      h_lab='MADE 2', v_lab='MADE 3',
                                      main_lab= paste0('MADE'), size=2.5)

linearsdr:::ggplot_fsdr(Y1_test, t((X1_test_std)%*%b_hat_made1[,c(1,3)]),
                                     y_on_axis=F,
                                      ytype="multinomial",
